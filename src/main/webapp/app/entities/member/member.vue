<template>
  <div>
    <h2 id="page-heading" data-cy="MemberHeading">
      <span id="member-heading">Members</span>
      ...
      <table class="table table-striped" aria-describedby="members">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('professionalEmail')">
              <span>Professional Email</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'professionalEmail'"></jhi-sort-indicator>
            </th>
        ...
        <tbody>
          <tr v-for="member in members" :key="member.id" data-cy="entityTable">
            ...
            <td>{{ member.professionalEmail }}</td>
            <td>{{ member.phone }}</td>
            <td class="text-right">
              <div class="btn-group">
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="cocovoitApp.member.delete.question" data-cy="memberDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-member-heading">Are you sure you want to delete this Member?</p>
      </div>
    ...
    <div v-show="members && members.length > 0">
