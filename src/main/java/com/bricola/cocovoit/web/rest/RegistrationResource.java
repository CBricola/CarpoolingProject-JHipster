...
import com.bricola.cocovoit.service.RegistrationService;
...
/**
 * REST controller for managing {@link com.bricola.cocovoit.domain.Registration}.
 */
@RestController
@RequestMapping("/api")
public class RegistrationResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/registrations/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Registration> partialUpdateRegistration(
        ...
        Optional<Registration> result = registrationService.partialUpdate(registration);
