...
describe('Component Tests', () => {
  describe('Path Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PathClass>(PathUpdateComponent, {
        store,
        localVue,
        router,
        provide: {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.path = entity;
        pathServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(pathServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.path = entity;
        pathServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(pathServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        pathServiceStub.retrieve.resolves([foundPath]);
